...
// ExcessiveMethodLength - Interface was given, unable to change method length
// ClassNamingConvention - The class name is descriptive enough
    ...
    public static Command parseCommand(String commandString, ApplicationRunner appRunner)
        ...
        while (!commandSubstring.isEmpty()) {
            ...
            case CHAR_REDIR_INPUT:
                // BUG FOUND: With the "break;" here, "<" was not being added into the tokens list. IORedirectionHandler.java was not getting any input arguments with "<" in it.
            ...
            case CHAR_SEMICOLON:
                ...
                // Reset tokens to not take into account the past data
                tokens = new LinkedList<>();
                break;
