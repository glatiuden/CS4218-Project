...
class MvApplicationPublicIT {
    ...
    @Test
    public void run_WnwritableSrcFile_ThrowsError() throws AbstractApplicationException {
        ...
        assertFalse(stdOutResult.toString().isEmpty());
    }

    @Disabled
    @Test
    public void run_UnwritableDestFileWithoutFlag_ThrowsError() throws Exception {
    ...
    @Test
    public void run_UnwritableDestFileWithFlag_ThrowsError() throws Exception {
    ...
    public void run_UnwritableDestFolder_ThrowsError() throws Exception {
    ...
    @Test
    public void run_WithoutFlagsSameSrcAndDestExist_ThrowError() throws AbstractApplicationException {
        String[] argList = new String[]{FILE_1_TXT, FILE_1_TXT};
        mvApplication.run(argList, System.in, System.out);
        assertEquals(MV_PREFIX + ERR_COPY_TO_SELF + STRING_NEWLINE, stdOutResult.toString());
    }

    @Test
    public void run_WithoutFlagsSameSrcToCurrFolder_ThrowError() throws AbstractApplicationException {
    ...
    @Test
    public void run_invalidSourceFile_ThrowError() throws AbstractApplicationException {
        String[] argList = new String[]{"file3.txt", FILE_1_TXT};
        mvApplication.run(argList, System.in, System.out);
        assertEquals(MV_PREFIX + ERR_FILE_NOT_FOUND + STRING_NEWLINE, stdOutResult.toString());
    }
    ...
    @Test
    public void run_NonExistentDestFolder_ThrowsException() throws AbstractApplicationException {
    ...
    @Test
    public void run_ExistentNonDirDestFile_ThrowsError() throws AbstractApplicationException {
    ...
    @Test
    public void run_NonExistentNonDirDestFile_ThrowsError() throws AbstractApplicationException {
    ...
    @Test
    public void run_InvalidSrcFileFirst_ThrowsError() throws AbstractApplicationException {
        String[] argList = new String[]{"f", SUBFOLDER_2, SUBFOLDER_1};
        mvApplication.run(argList, System.in, System.out);
        assertEquals(MV_PREFIX + ERR_FILE_NOT_FOUND + STRING_NEWLINE, stdOutResult.toString());

        File expectedRemainingFile = new File(tempDir, SUBFOLDER_2);
        assertFalse(expectedRemainingFile.exists());
    }

    @Test
    public void run_InvalidSrcFilesAfter_ThrowsError() throws AbstractApplicationException {
